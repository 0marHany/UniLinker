...
const { getAllCollage, addCollage, putCollage, deleteCollage, getCollage,searchFun } = require("../controller/Collage.controller");

const routes =require("express").Router();

routes.get("/collage/:uni_id",getAllCollage);
routes.get("/collage", searchFun);
routes.get("/collage/specific/:col_id",getCollage);
